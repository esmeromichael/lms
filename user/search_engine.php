...
<div class="container">
	...
	<div class="span12">
	<div>
	<p><a href="login_search.php" class="btn btn-info"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p></div>
		<div class="alert alert-info">List of Available Books</div>
						<center class="title">
						<h1>Books List</h1>
						</center>
							...
							<thead>
                                ...
                                <tbody>								
                                <?php
									if(mysql_num_rows($user_query=mysql_query("select * from book_title
									...
									where book_title.stat_book='Available' and book_title.book_title LIKE '%$title%' GROUP BY book_title.book_title"))>0){
