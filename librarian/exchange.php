    ...
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
			   ...
			   <!--  -->
				<ul class="nav nav-pills"> 
					...
					<li class="active"><a href="exchange.php"> Exchange Books</a></li>									
			...
			<div class="span10">
			   ...
			   <!--  -->
				<center class="title">
				<label>LIST OF EXCHANGE BOOKS</label>
				</br>
				</br>
				</center>
				
                <table cellpadding="1" cellspacing="0" border="1" class="table  table-bordered" id="example">
               ...
               <?php 									
				...
				where book_title.acquisition_id='1' GROUP BY book_title.access_id ORDER BY book_title.acc_num  ASC")or die(mysql_error());
				...
				?>
					...
					<?php
					$query = mysql_query("SELECT * FROM book_title where acquisition_id ='1' and access_id='$row[access_id]'");
