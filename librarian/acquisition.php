    ...
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
			   ...
			   <!--  -->
				<ul class="nav nav-pills"> 
					<li class="active"><a href="#">Donated Books</a></li>
			...
			<div class="span10">
			   <!--  -->
				<center class="title">
				<label>LIST OF DONATED BOOKS</label>
				</br>
				</br>
				</center>
				<center>
                <table cellpadding="0" cellspacing="1" border="1" class="table  table-bordered" id="example">
               ...
               <?php 									
				...
				where book_title.acquisition_id='2' GROUP BY book_title.access_id ORDER BY book_title.acc_num  ASC")or die(mysql_error());
				...
				?>
					...
					<?php
					$query = mysql_query("SELECT * FROM book_title where acquisition_id ='2' and access_id='$row[access_id]'");
