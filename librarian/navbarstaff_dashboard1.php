      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="active"><a href="staff_dashboard.php"><i class="icon-home icon-large"></i>&nbsp;Home</a></li>
					...
					?>
					<li><a href="staff_books.php"><i class="icon-book icon-large"></i>&nbsp;Book Details</a></li>
