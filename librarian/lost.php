		...
		<div class="row">	
			<div class="span12">	
			   <div class="alert alert-info">
					...
					<ul class="nav nav-pills"> 
						...
						<li><a href="damage.php">Damage Books</a></li>									
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_lost.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Lost Books</a>
                                <thead>
                                    <tr>
				...
				where book_title.stat_book='Lost' ORDER BY book_title.acc_num  ASC")or die(mysql_error());
