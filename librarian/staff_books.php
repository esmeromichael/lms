			...
			<div class="span12">	
			   ...
			   <!--  -->
				<ul class="nav nav-pills"> 
					<li class="active"><a href="staff_books.php">All Books</a></li>										
			   ...
			   <!--  -->
                ...
                <thead>
					...
					<th><center>Copyright Year</center></th>	
					<th>Available</th>
					<th>Reserve</th>
					<th><center>Copy/s</th>										
                    </tr>
               ...
               <?php 									
				...
				?>
					<tr class="del">
                    <td class="action"> <a href="#" onclick="view_func('<?php echo $row['access_id']; ?>','<?php echo $row['acquisition_id']; ?>');" ><i class="icon-file icon-large"></i> View</a>
					</td>
