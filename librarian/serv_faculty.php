...
<?php include('navbar_services.php'); ?>
    <div class="container">
		...
		<form method="post" action="borrow_faculty_save.php">
		<div class="span2">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								<?php
                                  ...
                                  $user_query=mysql_query("select * from book_title
									...
									<?php
									//$borrow_details=mysql_query("select * from book_title where access_id='$access_id' and stat_book='Available'")or die(mysql_error());									
