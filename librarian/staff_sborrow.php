	...
	<div class="span12">
		<div class="row">	
			...
			<ul class="nav nav-pills"> 
				<li><a href="staff_slogin_search.php">Research</a></li>										
				<li class="active"><a href="staff_sborrow.php">Borrow</a></li>																												
			</ul> 
		<div class="span12">		
		<form method="post">
		<div class="span3">
			...
			<label class="control-label" for="inputPassword"><strong>Student ID Number: </strong></label>
				<div class="controls">
...
mysql_query("insert into borrow_info(id_number,acc_num,date_borrow,time_borrow,due_time,due_date,borrow_stat)
			values('$id','$t',NOW(),NOW(),'$gettime[return_due]','$ex','Pending')")or die(mysql_error());
